...
By default it uses global mouse event monitoring for drag-follow and hover readouts. Run with `--no-mouse-monitor`, or set `CODEX_PET_LIMIT_RINGS_NO_MOUSE_MONITOR=1` for helper scripts, to disable that behavior.
