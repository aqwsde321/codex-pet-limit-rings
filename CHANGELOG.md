...
- No-mouse-monitor mode now keeps readouts visible instead of requiring hover detection.
- Readout detail text now avoids custom kerning to prevent an AppKit/CoreText text-measurement crash.
